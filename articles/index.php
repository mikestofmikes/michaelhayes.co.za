...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col" x-data="{ mobileMenuOpen: false }">
    ...
    <section id="about" class="p-3 md:p-20 bg-white md:max-w-3xl mx-auto py-12 pt-32 grid grid-cols-2 gap-4">
        <a href="/articles/aaaaaiiii.php">
            <div class="h-[100px] md:h-[190px]"><img src="/img/Embedded-AI.jpg" alt="AI " class=" "></div>
